...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dt.execute(args.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS).toArray(new Integer[]{}));
	}
	...
	public class DownloaderTask extends AsyncTask<Integer, Integer, String[]> {
		...
		@Override
		protected String[] doInBackground(Integer... passing) {
			return downloadTweets(passing);
		}

		@Override
		protected void onPostExecute(String result[]) {
			for (int index = 0; index < result.length; index++) {
				Log.i("Kenny", " index = " + index + " result = " + result[index]);
			}
